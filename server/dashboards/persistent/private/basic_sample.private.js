return {
  ...
  dataSources: [
    ...
    },
    {
      ...
      params: {
        query: "{medicalDocuments(pageSize:10, afterId:0, direction: 0, sortBy:\"\") { values {id firstName lastName }} }"
      },
    ...
    },
    {
      ...
      type: "GraphQL",
      dependencies: { timespan: "timespan" },
      params: { query: "{medicalDocuments(pageSize:10, afterId:0, direction: 0, sortBy:\"\") { totalCount } }" },
      format: {
        type: "scorecard",
        args: {
  ...
  elements: [
    {
      ...
      dependencies: {
        ...
        card_warnings_onClick: "::onWarningsClick"
      },
      actions: {
        onRecordsClick: {
        ...
        onWarningsClick: { action: "dialog:userRetention", params: { title: "args:heading", queryspan: "::P90D" } }
      }
    }
  ],
  dialogs: [
    {
      ...
      dataSources: [
        ...
        },
        {
          ...
          params: {
            query: ({ id }) => `{
              medicalDocument(id: ${id}, pageSize: 10, sortBy: "MedicalDocumentId") {
                totalCount
                values {
          ...
          format: { type: "graphql", values: "medicalDocument.values" }
        },
      ...
      elements: [
        {
          ...
          props: {
            ...
            group: { field: "firstName", secondaryField: "lastName"/*, countField: "id"*/ }
          },
          actions: {
            select: {
              action: "record-selection:updateDependencies",
              params: {
                id: "args:id",
              }
            }
